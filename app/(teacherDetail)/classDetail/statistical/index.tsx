import { FontAwesome5, FontAwesome6, Foundation, Ionicons, MaterialCommunityIcons } from '@expo/vector-icons';
...
export default function Statistical({}: Props) {
  ...
  const rollCall = () => {
    router.push(`/(teacherDetail)/classDetail/statistical/rollCall`)
  }
  const review = () => {
    router.push(`/(teacherDetail)/classDetail/statistical/review`)
  }
  return (
    <SafeAreaView>
