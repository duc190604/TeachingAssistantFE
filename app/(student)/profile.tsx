      ...
      <View >
        ...
        <View className='items-center justify-center '>
          <View className=' border-blue_primary border-[2px] rounded-full p-[1px]'>
            <Image className="overflow-hidden w-20 h-20 rounded-full " resizeMode="cover" source={image ? { uri: image } : images.avatarDefault} />
          </View>
        ...
        <View className='mt-4'>
          <View className='flex-row items-center pl-[5%] border-b-[1px] mx-4 pb-1 border-gray_line'>
                ...
                <Text numberOfLines={1} ellipsizeMode='tail' className='text-base ml-[5%] pr-3'>{user?.email}</Text>
          </View>
