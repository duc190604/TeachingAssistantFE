...
import { View, Image, Text, Modal, TouchableOpacity, Linking, Pressable, Alert, TextInput } from "react-native";
       ...
       >
         {isResolved && (
           <View className="absolute px-2 py-1 top-[-14px] right-0 bg-white border border-gray-200 rounded-md shadow-lg flex-row items-center">
             <Text className=" text-[#34eb75]  rounded-md mr-1">
               Đã trả lời
             </Text>
         ...
         <TouchableOpacity
           ...
           className="-mb-8 mt-2 bg-white rounded-full p-1 items-center justify-center border border-gray-200 flex-row w-[130px]"
         >
